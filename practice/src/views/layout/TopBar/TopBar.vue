<template>
    <div class=" w-full flex justify-between items-center" style="background-color: #08c384;">
        ...
        <div>
            ...
            <p class="mr-12">{{ $store.cart.length }}</p>
        </div>
